...
# Aggiungi project root a sys.path per nq-backtest-clean
CLEAN_ROOT = Path(r"C:\Users\Mauro\Documents\nq-backtest-clean")
sys.path.insert(0, str(CLEAN_ROOT))

from src.agents.llm_client import llm_ask

def main():
    # Leggi il file dal progetto corrente
    current_root = Path(r"C:\Users\Mauro\Documents\nq-backtest")
    status_file = current_root / "STATUS_REVIEW_KIMI.md"
...
"""
    ...
    output_file = current_root / "KIMI_REVIEW_RESPONSE.md"
