...
def main():
    ...
    print("\n=======================================================")
    print("ANALISI CACCIA AGLI STOP -> SOLO NELLA STRATEGIA V2 CASO A")
    print("=======================================================\n")
    ...
    for pat in ["trend_long", "absorb_long", "trend_short", "absorb_short"]:
        ...
        print(f"--- SETUP: {pat.upper()} (Campione filtrato V2: {total_trades}) ---")
        print(f"  Volte in cui il NQ ha spazzato lo SL Strutturale ed e' ripartito in Gain: {num_sweeps} ({sweep_pct:.1f}%)")
        if num_sweeps > 0:
            print(f"  Profondita' MEDIA della caccia allo stop: {avg_depth:.1f} punti")
            print(f"  Profondita' MAX della caccia allo stop:   {max_depth:.1f} punti")
        print()
