...
def simulate_trade(bars, entry_idx, direction, sl, tp, delay_minutes=0, base_contracts=2):
...
def main():
    ...
    print("\n=======================================================")
    print("STATISTICHE MENSILI - MASTER STRATEGY V3")
    ...
    print("\n--- SOMMARIO ---")
    print(f"Profitto Totale Netto (18 Mesi): ${total_pnl:,.2f}")
    ...
    print(f"Drawdown 90° Percentile:         ${p90:,.2f}")
