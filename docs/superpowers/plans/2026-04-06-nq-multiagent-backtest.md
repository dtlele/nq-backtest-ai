...
```bash
git -C C:\Users\Mauro\Documents\nq-backtest-clean init
git -C C:\Users\Mauro\Documents\nq-backtest-clean add src/__init__.py src/data_loader.py tests/test_data_loader.py requirements.txt
git -C C:\Users\Mauro\Documents\nq-backtest-clean commit -m "feat: data structures + DataBento CSV loader"
```
...
```bash
git -C C:\Users\Mauro\Documents\nq-backtest-clean add src/bar_aggregator.py tests/test_bar_aggregator.py
git -C C:\Users\Mauro\Documents\nq-backtest-clean commit -m "feat: bar aggregator with OHLCV, delta, CVD, big trades"
```
...
```bash
git -C C:\Users\Mauro\Documents\nq-backtest-clean add src/volume_profile.py tests/test_volume_profile.py
git -C C:\Users\Mauro\Documents\nq-backtest-clean commit -m "feat: volume profile with VA, POC, HVN, LVN"
```
...
```bash
git -C C:\Users\Mauro\Documents\nq-backtest-clean add src/session_context.py src/candidate_detector.py tests/test_session_context.py tests/test_candidate_detector.py
git -C C:\Users\Mauro\Documents\nq-backtest-clean commit -m "feat: session context + candidate bar detector"
```
...
```bash
git -C C:\Users\Mauro\Documents\nq-backtest-clean add src/signal_context.py tests/test_signal_context.py
git -C C:\Users\Mauro\Documents\nq-backtest-clean commit -m "feat: signal context builder for agents"
```
...
```bash
git -C C:\Users\Mauro\Documents\nq-backtest-clean add src/agents/ tests/test_agents.py .env.example
git -C C:\Users\Mauro\Documents\nq-backtest-clean commit -m "feat: Andrea Cimi + Fabio Valentini Claude agents with mocked tests"
```
...
```bash
git -C C:\Users\Mauro\Documents\nq-backtest-clean add src/consensus.py src/trade_simulator.py tests/test_consensus.py tests/test_trade_simulator.py
git -C C:\Users\Mauro\Documents\nq-backtest-clean commit -m "feat: consensus layer + trade simulator"
```
...
```bash
git -C C:\Users\Mauro\Documents\nq-backtest-clean add src/backtest_runner.py src/metrics_reporter.py run_backtest.py tests/test_metrics_reporter.py
git -C C:\Users\Mauro\Documents\nq-backtest-clean commit -m "feat: backtest runner + metrics reporter — full system complete"
```
