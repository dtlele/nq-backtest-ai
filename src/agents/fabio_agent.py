...
Respond ONLY with valid JSON matching this schema:
{
  ...
  "reasoning": "<MAX 150 WORDS. Spiega in modo discorsivo l'analisi dei Big Trades, i partecipanti intrappolati e i risultati qualitativi del tuo self-audit temporale/regime. Quale lato è in trappola? Il delta conferma l'iniziativa o c'è assorbimento passivo sui muri? Giustifica la scelta dello Stop Loss strutturale. Scrivi un paragrafo fluido senza elenchi puntati o chiavi JSON.>",
  "temporal_audit": "q1:XX%, q2:XX%, q3:XX%, q4:XX%, q5:XX% (calcola esplicitamente le percentuali per i 5 fattori per forzare il ragionamento)",
  "market_narrative_update": "<Costruisci un ragionamento fluido e consequenziale della sessione focalizzandoti sui Big Trades. Puoi restituire direction='none' e usare questo campo per dichiarare cosa stai aspettando.>",
